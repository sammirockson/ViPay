...
class ConfirmOrderCollectionViewCell: UICollectionViewCell {
    ...
    func setUpViews(){
        ...
        revealButton.addSubview(trashCanImageView)
        
        trashCanImageView.centerXAnchor.constraint(equalTo: revealButton.centerXAnchor).isActive = true
        trashCanImageView.centerYAnchor.constraint(equalTo: revealButton.centerYAnchor).isActive = true
        trashCanImageView.widthAnchor.constraint(equalToConstant: 32).isActive = true
        trashCanImageView.heightAnchor.constraint(equalToConstant: 32).isActive = true
        ...
        revealButton.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -8).isActive = true
        revealButton.leftAnchor.constraint(equalTo: customViewCell.rightAnchor, constant: 8).isActive = true
        revealButton.heightAnchor.constraint(equalTo: self.heightAnchor, constant: -10).isActive = true
        revealButton.centerYAnchor.constraint(equalTo: self.centerYAnchor).isActive = true
